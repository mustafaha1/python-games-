...
winsound.PlaySound('theme.wav', winsound.SND_FILENAME | winsound.SND_ASYNC) # main music
print("\033[31;47m")
princess = """
    ___                                ____    _                      ___           __                                                   
   F __".   ___ _  _    _   ____      /_  _\  FJ___      ____        F _ ", _ ___   LJ   _ ___      ____      ____      ____      ____   
  J (___|  F __` LJ |  | L F __ J     [J  L] J  __ `.   F __ J      J `-' |J '__ ",     J '__ J    F ___J.   F __ J    F ___J    F ___J  
  J\___ \ | |--| |J J  F L| _____J     |  |  | |--| |  | _____J     |  __/F| |__|-J FJ  | |__| |  | |---LJ  | _____J  | '----_  | '----_ 
 .--___) \F L__J JJ\ \/ /FF L___--.    F  J  F L  J J  F L___--.    F |__/ F L  `-'J  L F L  J J  F L___--. F L___--. )-____  L )-____  L
 J\______J\____,__L\\__//J\______/F   J____LJ__L  J__LJ\______/F    J__|   J__L     J__LJ__L  J__LJ\______/FJ\______/FJ\______/FJ\______/F
  J______FJ____,__F \__/  J______F    |____||__L  J__| J______F     |__L   |__L     |__||__L  J__| J______F  J______F  J______F  J______F 
                                                                                                                                                                                                                                                                                                                                                                                                   
"""
print(princess)

print("\033[30;42m")
print("# Play in fullscreen for the best experience! # ")
...
def short_cut(text, monster): # function for the player chosen shortcut option
    ...
    time.sleep(2)
    print(monster)
    winsound.PlaySound('fighting.wav', winsound.SND_FILENAME | winsound.SND_ASYNC) # fight music
    print("\033[31;47m background light green")
    short_cut_monster = """\
---------------------------------------------------
                                |     |           |
                                \\_V_//            | 
...
def find_p(option):
    ...
    if option == '1':
        ...
        time.sleep(1)
        print("\033[36;47m")
        winsound.PlaySound('endgame.wav', winsound.SND_FILENAME | winsound.SND_ASYNC) # end music
        winsound.PlaySound('congrat.wav', winsound.SND_FILENAME | winsound.SND_ASYNC) # voice music
        horse_ascii = """
-------------------------------------------------------
                    (,);    /\                        | 
                   ((  ^_   ||            ...         |
...
def key():
    ...
    if option1 == '1':
        time.sleep(1)
        print("\033[32;47m")
        winsound.PlaySound('chestt.wav', winsound.SND_FILENAME | winsound.SND_ASYNC) # chest music
        chest_ascii = """
----------------------------
         __________        |
        /\____;;___|       |
...
----------------------------
      ...
      """
        ...
        time.sleep(1)
        print("\033[33;42m")
        winsound.PlaySound('keysound.wav', winsound.SND_FILENAME | winsound.SND_ASYNC) # key music
        key_ascii = """
-----------------------------------------------
                                              |
     8 8 8 8                     ,ooo.        |
...
def castle():
    ...
    if choice1 == "1":
        ...
        print("\033[35;47m")
        winsound.PlaySound('sadsong.wav', winsound.SND_FILENAME | winsound.SND_ASYNC) # sad music
        princessascii = """
===============================================        
        .....                                  |
         WWWWW                                 |
